...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.qwbarch/snowflake4s_3)](https://search.maven.org/artifact/io.github.qwbarch/snowflake4s_3/1.1.0-M3/jar)
...
```scala
libraryDependencies += "io.github.qwbarch" %% "snowflake4s" % "1.1.0-M3"
```
